...
- Typing: Quick-Play
- Archetype: Radiant Typhoon
- Text: If this card is destroyed by the effect of "Mystical Space Typhoon": You can Set this card. Activate 1 of these effects (but you can only use each of these effects of "Radiant Typhoon Vision" once per turn);
...
- Typing: Quick-Play
- Archetype: Radiant Typhoon
- Forbidden & limited list: Limited (as of 2026-05-18)
- Text: If this card is destroyed by the effect of "Mystical Space Typhoon": You can Set this card. Activate 1 of these effects (but you can only use each of these effects of "Radiant Typhoon Chant" once per turn);
...
- Typing: Quick-Play
- Archetype: Radiant Typhoon
- Text: If this card is destroyed by the effect of "Mystical Space Typhoon": You can Set this card. Activate 1 of these effects (but you can only use each of these effects of "Radiant Typhoon Ascendance" once per turn);
...
- Typing: Quick-Play
- Archetype: Radiant Typhoon
- Text: If this card is destroyed by the effect of "Mystical Space Typhoon": You can Set this card. Activate 1 of these effects (but you can only use each of these effects of "Radiant Typhoon Manifestation" once per turn);
...
- Typing: Continuous
- Archetype: Radiant Typhoon
- Text: Once per turn: You can target 3 Quick-Play Spells in your GY, including a "Radiant Typhoon" card; apply the following effects in sequence.
...
- Engine class: Engine
- Role: Conditional Starter
- Condition: Requires at least one copy of Noble Knight's Shield-Bearer present in the Main Deck in order to function as a starter. Also requires the OPT normal summon in order to function as a starter.
...
- Attribute: WIND
- Level/Rank: 9
- Text: The first time this card would be destroyed by battle each turn, it is not destroyed. When your opponent activates a card or effect, while you control a WIND monster (Quick Effect): You can Special Summon this card from your hand, then apply the following effect based on what was activated.
...
- Typing: Quick-Play
- Archetype: Branded
- Text: (This card is always treated as a "Branded" and "Dogmatika" card.)
...
- Type: Spell
- Typing: Quick-Play
- Text: Apply these effects to 1 face-up monster on the field, until the end of this turn.
● Negate its effects.
● Cannot attack.
...
- Attribute: WIND
- Level/Rank: 4
- Text: If you control no cards (Quick Effect): You can discard this card; apply these effects this turn.
...
- Attribute: WIND
- Link: 2
- Text: 2 monsters, including a WIND monster
...
### Annotations (Agnes)
- Role: The Fallen & The Virtuous Target
...
- Level/Rank: 8
- Archetype: Branded
- Text: "Fallen of Albaz" + 1 LIGHT monster
...
- Level/Rank: 8
- Archetype: Branded
- Text: "Fallen of Albaz" + 1 LIGHT or DARK monster + 1 Effect Monster
...
### Annotations (Agnes)
- Role: The Fallen & The Virtuous Target, Super Polymerization Target
...
- Attribute: WATER
- Level/Rank: 4
- Text: 2 monsters with the same Attribute but different Types
...
### Annotations (Agnes)
- Role: Super Polymerization Target
...
- Attribute: DARK
- Level/Rank: 6
- Text: 2 monsters with the same Type and Attribute, but different names
